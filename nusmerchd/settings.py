"""
Django settings for nusmerchd project.
...
EMAIL_HOST_PASSWORD = 'ngenxin2000'
EMAIL_PORT = 587
...
SECRET_KEY = 'llrnvytun96n#8$x7k9@)9hfdnh$snxdgo-^)!f)vi6g7-rnht'
...
WSGI_APPLICATION = 'nusmerchd.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'nusmerchd/media')
